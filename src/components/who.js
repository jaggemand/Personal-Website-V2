import img_full from "../images/me-full.jpg"

const people = [
    {
      name: 'Jacob Kyed Andreassen',
      role: 'Computer Science Student',
      twitterUrl: 'https://twitter.com/jaggemand',
      linkedinUrl: 'https://www.linkedin.com/in/jacob-kyed-andreassen/',
    },
    // More people...
  ]
                ...
                <li key={person.name}>
                  <div className="space-y-12">
                    <div className="aspect-w-3 aspect-h-2">
                      <img className="object-cover h-72 shadow-lg rounded-lg" src={img_full} alt="" />
                    </div>
